...
class Footman(Actor):
    def __init__(self, x, y, z, **params):
        ...
        self.sprite = Sprite('images/Footman_0_0.png')
        self.states = {'down': Sprite('images/Footman_0_0.png'), 'down_right': Sprite('images/Footman_1_0.png'), 'right': Sprite('images/Footman_2_0.png'), 'up_right': Sprite('images/Footman_3_0.png'),
                       'up': Sprite('images/Footman_4_0.png'), 'down_left': Sprite('images/Footman_5_0.png'), 'left': Sprite('images/Footman_6_0.png'), 'up_left': Sprite('images/Footman_7_0.png')}
