...
image_2_2 = Sprite('images/mage_2_0.png')
...
states_3 = {'right': [image_2_2_0, image_2_2_1, image_2_2_2, image_2_2_3, image_2_2_4]}

Knight = first_game.new_actor('Knight', category='pc', strange=5, wizdom=10)
k = Knight(0, 0, 0, image_2_1, states_0, canvas) # требуется закомментировать, если выбран вариант animate_sprite
...
Knight1 = first_game.new_actor('Knight1', category='npc', strange=5, wizdom=10, sprite=image_3_0) # требуется закомментировать, если выбран вариант animate_sprite
k2 = Knight1(0, 0, 0, image_3_0, states_1, canvas) # требуется закомментировать, если выбран вариант animate_sprite
...
Bandit = first_game.new_actor("Bandit", category="NPC", strange=12, wizdom=8, sprite=image_3_0) # требуется закомментировать, если выбран вариант animate_sprite
b = Bandit(0, 0, 0, image_4_0, states_2, canvas) # требуется закомментировать, если выбран вариант animate_sprite
